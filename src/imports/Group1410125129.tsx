import svgPaths from "./svg-ixy1f48tju";
...
function Component3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[14px] h-[638.584px] items-center left-0 px-[16px] rounded-[8px] top-[582.67px]" data-name=".">
      <Group4 />
      <Frame20 />
      <div className="h-0 relative shrink-0 w-[349px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 349 1">
            <line id="Line 217" stroke="var(--stroke-0, black)" x2="349" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <Frame20 />
      ...
      <Frame20 />
      <p className="css-4hzbpn font-['Helvetica_Neue:Regular',sans-serif] leading-[30px] not-italic relative shrink-0 text-[#1e1709] text-[16px] text-center tracking-[1px] uppercase w-[361px]">Upload a pic of your favourite outfit To start</p>
      <Frame19 />
      <ButtonDark />
    </div>
  );
