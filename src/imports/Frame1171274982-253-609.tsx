import svgPaths from "./svg-d2gyhsl728";
...
function Group5() {
  return (
    <div className="absolute contents inset-[77%_8.05%_7%_4.03%]">
      <Group1 />
      <div className="absolute flex flex-col font-['Helvetica_Neue:Regular',sans-serif] inset-[77%_26%_7%_26.5%] justify-center leading-[0] not-italic text-[#1e1709] text-[13px] text-center tracking-[1px] uppercase">
...
function Group8() {
  return (
    <div className="absolute contents inset-[79.87%_8.05%_9.4%_4.03%]">
      <Group2 />
      <div className="absolute flex flex-col font-['Helvetica_Neue:Regular',sans-serif] inset-[81%_23.5%_11%_24%] justify-center leading-[0] not-italic text-[#1e1709] text-[13px] text-center tracking-[1px] uppercase">
        <p className="css-4hzbpn leading-[22px]">CHRIS WHYLE</p>
      </div>
    </div>
  );
}
