  ...
  return (
    <div className="relative w-full min-h-screen overflow-x-hidden bg-[#fffefd]">
      ...
      <div className="bg-[#fffefd] h-[48px] w-full overflow-clip">
        <button 
          className="absolute left-[16px] size-[24px] top-[12px]"
          onClick={() => navigate(-1)}
        >
      ...
      <div className="w-full max-w-[393px] mx-auto px-4 pb-8">
        ...
        {/* Horizontal scroll of product images with like buttons */}
        {productLinks.length > 0 && (
          <div className="flex gap-[8px] overflow-x-auto pb-2 mb-6 -mx-4 px-4 scrollbar-hide">
        ...
        <div className="flex items-center justify-end gap-[8px]">
          ...
          <div className="bg-[#1e1709] h-[24px] w-[44px] rounded-[40px] relative">
            <div className="absolute bg-white left-[2px] rounded-full size-[20px] top-[2px]" />
          </div>
        </div>
      </div>
