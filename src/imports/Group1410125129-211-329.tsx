import svgPaths from "./svg-qnkty5boya";
...
function Component3() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[14px] h-[638.584px] items-center left-0 px-[16px] rounded-[8px] top-[582.67px]" data-name=".">
      ...
      <p className="css-4hzbpn font-['Helvetica_Neue:Regular',sans-serif] leading-[25px] not-italic relative shrink-0 text-[#1e1709] text-[14px] text-center tracking-[1px] uppercase w-[361px]">Upload a Reference pic of your favourite outfit To get started</p>
      <Frame19 />
      <ButtonDark />
    </div>
  );
