...
export default function HomePage() {
  ...
  return (
    <IonPage className="overflow-x-hidden">
      {/* Header */}
      <IonHeader>
      ...
      <IonContent fullscreen className="bg-[#fffefd] overflow-x-hidden"
 style={{ '--overflow-x': 'hidden' } as React.CSSProperties}>
        <div className="w-full max-w-full overflow-x-hidden">
          ...
          <div className="mb-4 mt-4">
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 pl-4 pr-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]" style={{ scrollSnapType: 'none', WebkitOverflowScrolling: 'touch' }}>
