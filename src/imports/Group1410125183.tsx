import svgPaths from "./svg-mjb2uq48cn";
...
function RightSide() {
  return (
    <div className="-translate-x-1/2 absolute h-[9.931px] left-[calc(83.33%+17.41px)] top-[12px] w-[57.825px]" data-name="Right Side">
...
function LeftSide() {
  return (
    <div className="-translate-y-1/2 absolute contents left-[16px] top-1/2" data-name="Left Side">
      <p className="-translate-x-1/2 absolute font-['Oswald:Medium',sans-serif] font-medium leading-[17.522px] left-[26.5px] text-[13.142px] text-black text-center top-[calc(50%-9px)] tracking-[-0.4381px]">9:41</p>
    </div>
  );
}
...
function Group6() {
  return (
    <div className="absolute contents inset-[82.66%_3.32%_3.76%_3.32%]">
      <Group4 />
      <div className="absolute flex flex-col font-['Helvetica_Neue:Medium',sans-serif] inset-[82.66%_21.94%_3.76%_23.71%] justify-center leading-[0] not-italic text-[#130326] text-[12px] text-center tracking-[2px] uppercase whitespace-nowrap">
        <p className="leading-[22px]">LISSY Roddy</p>
      </div>
    </div>
  );
}
...
function Create() {
  return (
    <div className="absolute bg-white h-[2154px] left-0 overflow-clip top-0 w-[439px]" data-name="Create">
      ...
      <CardImage />
      <p className="-translate-x-1/2 absolute font-['Helvetica_Neue:Regular',sans-serif] leading-[normal] left-[219.5px] not-italic text-[#1e1709] text-[18px] text-center top-[915px] tracking-[2px] uppercase w-[361px] whitespace-pre-wrap">STYLING NOTES</p>
      <div className="absolute font-['Helvetica_Neue:Regular',sans-serif] h-[420px] leading-[24px] left-[calc(50%-180.5px)] not-italic text-[#1e1709] text-[14px] top-[964px] tracking-[1px] uppercase w-[361px] whitespace-pre-wrap">
        <p className="mb-0">You already have a natural ease in your style. What we’re doing now is simply refining it, giving your look that quiet, modern polish.</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">Focus on a few elevated accessories: a structured bag, a clean belt, shoes with intention. Keep a neutral base and add one or two tones that highlight your features in your case blue hues. It creates cohesion and gives your wardrobe a signature feel.</p>
        <p className="mb-0">&nbsp;</p>
        <p>Everything selected for you is meant to express your style at its most refined: modern, effortless, and unmistakably you.</p>
      </div>
...
function Component() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[14px] h-[490px] items-center left-0 px-[16px] rounded-[8px] top-[148px] w-[442px]" data-name=".">
      <Group10 />
      <Frame />
      <p className="font-['Helvetica_Neue:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#1e1709] text-[18px] text-center tracking-[2px] uppercase w-[361px] whitespace-pre-wrap">YOUR SEVN SELECTS</p>
      <Frame2 />
      <p className="font-['Helvetica_Neue:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#1e1709] text-[14px] text-center tracking-[1px] uppercase w-[361px] whitespace-pre-wrap">{`Handpicked Edit + styling tips `}</p>
      <Frame3 />
...
function Group16() {
  return (
    <div className="absolute contents left-0 top-0">
      <Group12 />
      <Group13 />
      <p className="-translate-x-1/2 absolute font-['Helvetica_Neue:Regular',sans-serif] h-[22.376px] leading-[22px] left-[219.31px] not-italic text-[24px] text-black text-center top-[72.21px] tracking-[3px] uppercase w-[438.626px] whitespace-pre-wrap">SEVN SELECTS</p>
...
function StatusBarIPhone1313Pro3() {
  return (
    <div className="absolute h-[34px] left-0 overflow-clip top-0 w-[375px]" data-name="StatusBar / iPhone 13 & 13 Pro">
      <Group3 />
    </div>
    ...
    <div className="absolute content-stretch flex flex-col gap-[10px] items-center justify-center left-[39px] top-[3046px] w-[361px]" data-name="Button/Dark">
      <div className="h-[52px] relative shrink-0 w-full">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 361 52">
          ...
          <defs>
            <clipPath id="bgblur_0_800_624_clip_path" transform="translate(4 4)">
              <path d={svgPaths.p119e9000} />
            </clipPath>
          </defs>
        </svg>
      </div>
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['IBM_Plex_Mono:Regular',sans-serif] justify-center leading-[0] left-1/2 not-italic text-[#fffefd] text-[14px] text-center top-[26px] whitespace-nowrap">
        <p className="leading-[normal]">GET ANOTHER EDIT</p>
      </div>
    </div>
  );
}
...
function Create1() {
  return (
    <div className="absolute bg-white h-[3146px] left-0 overflow-clip top-0 w-[439px]" data-name="Create">
      ...
      <StatusBarIPhone1313Pro3 />
      <CardImage1 />
      <p className="-translate-x-1/2 absolute font-['Helvetica_Neue:Regular',sans-serif] leading-[normal] left-[219.5px] not-italic text-[#1e1709] text-[18px] text-center top-[950px] tracking-[2px] uppercase w-[361px] whitespace-pre-wrap">STYLING NOTES</p>
      <p className="-translate-x-1/2 absolute font-['Helvetica_Neue:Regular',sans-serif] leading-[normal] left-[219.5px] not-italic text-[#1e1709] text-[18px] text-center top-[1442px] tracking-[2px] uppercase w-[361px] whitespace-pre-wrap">SEVN SELECTS</p>
      <div className="absolute font-['Helvetica_Neue:Regular',sans-serif] h-[311px] leading-[24px] left-[calc(50%-180.5px)] not-italic text-[#1e1709] text-[14px] top-[999px] tracking-[1px] uppercase w-[361px] whitespace-pre-wrap">
        <p className="mb-0">You already have a natural ease in your style. What we’re doing now is simply refining it, giving your look that quiet, modern polish.</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">Focus on a few elevated accessories: a structured bag, a clean belt, shoes with intention. Keep a neutral base and add one or two tones that highlight your features in your case blue hues. It creates cohesion and gives your wardrobe a signature feel.</p>
        <p className="mb-0">&nbsp;</p>
...
function Group17() {
  return (
    <div className="absolute contents left-0 top-0">
      <Group14 />
      <Group15 />
      <p className="-translate-x-1/2 absolute font-['Helvetica_Neue:Regular',sans-serif] h-[26.105px] leading-[22px] left-[219.31px] not-italic text-[24px] text-black text-center top-[110.83px] tracking-[3px] uppercase w-[438.626px] whitespace-pre-wrap">SEVN SELECTS</p>
